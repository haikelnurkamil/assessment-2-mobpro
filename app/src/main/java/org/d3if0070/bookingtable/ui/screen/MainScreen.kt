...
import org.d3if0070.bookingtable.navigation.Screen
import org.d3if0070.bookingtable.util.SettingsDataStore
...
@Composable
fun ListItem(table: Table, onClick: () -> Unit ){
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
...
@Composable
fun GridItem(table: Table, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
